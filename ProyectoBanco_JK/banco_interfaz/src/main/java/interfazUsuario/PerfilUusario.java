 ...
 */
public class PerfilUusario extends javax.swing.JFrame {

    /**
     * Creates new form PerfilUusario
     */
    public PerfilUusario() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PerfilUusario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PerfilUusario().setVisible(true);
            }
        });
    }
